...
%=================================================================================
\textbf{1 Метод Гаусса для решения СЛАУ}

Задача: Решить систему линейных алгебраических уравнений вида $Ax = b$ методом Гаусса с выбором главного элемента в столбце, где $A$ - квадратная матрица, $x$ - вектор неизвестных, $b$ - вектор свободных членов.
\[
A = \begin{pmatrix}
3 & 1 & -1 & 0 & 3 & 2 \\
1 & -2 & 0.5 & 4 & -1 & 3 \\
